...
function showPillarDetail(pillar) {
    ...
    topicsList.innerHTML = pillar.topics.map((topic, idx) => 
        `<div class="topicItem" onclick="showItemDetail('topic', '${pillar.id}', ${idx}, '${escapeHtml(topic)}')"><strong>${topic}</strong></div>`
    ).join('');
